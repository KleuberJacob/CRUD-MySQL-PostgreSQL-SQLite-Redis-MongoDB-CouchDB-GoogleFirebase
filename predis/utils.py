...
def gera_id():
    try:
        ...
        print(f'Nao foi possível gerar a chave: {e}')
...
def listar():
    ...
    try:
        ...
        print(f'Nao foi possível listar os produtos. {e}')
    desconectar(conn)
...
def inserir():
    ...
    estoque = int(input('Informe a quantidade do produto em estoque: '))
    ...
    try:
        ...
        print(f"Nao foi possível inserir o produto: {e}")
    desconectar(conn)
...
def atualizar():
    ...
    chave = input('Informe a chave do produto que deseja atualizar: ')
    nome = input('Informe o nome do produto: ')
    preco = float(input('Informe o preço do produto: '))
    estoque = int(input('Informe a quantidade do produto em estoque: '))
    ...
    try:
        ...
        print(f"Nao foi possível atualizar o produto: {e}")
    desconectar(conn)
...
def deletar():
    ...
    chave = input('Informe a chave do produto que deseja excluir: ')
    ...
    try:
        ...
        if res == 1:
            ...
            print('Nao foi possível excluir o produto com a chave informada.')
    except redis.exceptions.ConnectionError as e:
        print(f"Erro ao conectar ao BD Redis: {e}")
    desconectar(conn)
